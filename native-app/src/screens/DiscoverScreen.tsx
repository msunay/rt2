...
import DiscoverPrivateList from '@/src/components/discoverPrivateList';
import DiscoverPublicList from '@/src/components/discoverPublicList';
...
} from '@/src/reducers/discoverScreenStateReducer';
