...
} from '@/src/reducers/playerQuestionStateReducer';
import {
  useCreateParticipationAnswerMutation,
  useGetOneQuizQuestionAnswerQuery,
} from '@/src/api/backendApi';

import type { Participation, ParticipationAnswer, QuizQuestionAnswer } from '@/src/types/Types';
...
interface Props {
  ...
  quizError: FetchBaseQueryError | SerializedError | null;
        ...
        <View style={styles.question_container}>
          ...
          <View style={{ marginBottom: 'auto', marginTop: 10 }}>
            <CountdownCircleTimer
              isPlaying
              duration={QuizParticipantManager.QUESTION_TIME / 1000}
