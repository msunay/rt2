...
const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 8159)), "C:\\dev\\codeworks\\projects\\rt2\\client\\src\\app\\page.tsx"],
          metadata: {
    ...
    manifest: undefined
        ...
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 4053)), "C:\\dev\\codeworks\\projects\\rt2\\client\\src\\app\\layout.tsx"],
          metadata: {
    icon: [(async (props) => (await Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 3881))).default(props))],
    apple: [],
    openGraph: [],
...
const pages = ["C:\\dev\\codeworks\\projects\\rt2\\client\\src\\app\\page.tsx"];
...
var __webpack_exports__ = __webpack_require__.X(0, [587,742], () => (__webpack_exec__(1709)));
